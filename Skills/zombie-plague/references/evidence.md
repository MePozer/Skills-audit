...
| Никогда не пытаться отменить действие на форварде, возврат которого игнорируется | Все вызовы CreateMultiForward в ZP 5.0.8a: 14 ET_CONTINUE, 25 ET_IGNORE; zp50_core.sma:58-69 | Подтверждено |
...
Неблокируемые (`ET_IGNORE` — возврат игнорируется, только узнать), 25:
